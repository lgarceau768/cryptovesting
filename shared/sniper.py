...
sender_address = web3.toChecksumAddress('0x01420a7b545ac6c99f2b91e9f73464aa69c6e248')
#('0xdCc20789098843025CD54d0799714545d894D85e') #the address which buys the token
tokenToBuy = web3.toChecksumAddress('0x8ef13629803fcfdbeaebbe357d795771896de670')
#('0x899559c7151ddc01Fc084341B36101EAC1B6C01B')
...
def buy():
    ...
    'from': sender_address,
    'value': web3.toWei(0.002,'ether'),#This is the Token(BNB) amount you want to Swap from
